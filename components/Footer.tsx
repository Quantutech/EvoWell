          ...
          <div className="max-w-[1440px] mx-auto px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                  ...
                  >
                    <div className="relative flex items-center">
                      <input 
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl py-4 px-5 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-brand-400 focus:bg-white/10 transition-all pr-14"
                        required
                      />
                      <button 
                        type="submit"
                        disabled={isSubmitted}
                        className="absolute right-2 p-2 bg-brand-500 text-white rounded-lg hover:bg-brand-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {isSubmitted ? (
              ...
              <div className="lg:col-span-5 text-center lg:text-right space-y-8">
                  <div>
                    <p className="text-[10px] font-bold uppercase tracking-widest text-brand-400 mb-2">Get in touch</p>
                    <div className="space-y-1">
                      <p className="text-2xl font-bold text-white tracking-tight">hello@evowell.com</p>
                      <p className="text-xl font-medium text-white/60 tracking-tight">+1 (310) 555 33 33</p>
                    </div>
                  </div>
            ...
            {/* Bottom Bar */}
            <div className="mt-24 pt-8 border-t border-white/5 flex flex-col-reverse md:flex-row justify-between items-center gap-8">
              ...
              <div className="flex gap-4">
                {[
                  ...
                  <a 
                    key={social.name}
                    href="#" 
                    className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-brand-600 hover:border-brand-500 transition-all duration-300"
